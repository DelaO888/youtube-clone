...
export const VideoGridItem = ({ id, title, channel, views, postedAt, duration, thumbnailUrl, videoUrl }: VideoGridItemProps) => {
    ...
    return <div className="flex flex-col gap-2" onMouseEnter={() => setIsVideoPlaying(true)}
        ...
        <a href={`/watch?v=${id}`} className="relative aspect-video">
            ...
            <video src={videoUrl} ref={videoRef} className={`block h-full object-cover absolute inset-0 transition-opacity duration-200  ${isVideoPlaying ? "opacity-100 delay-200" : "opacity-0"}`}
